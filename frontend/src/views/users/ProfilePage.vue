...
export default {
  ...
  computed: {
    ...
    roleName() {
      ...
      return (
        this.userData.role_name || (this.isProfesor ? "Profesor" : "Alumno")
      );
    },
  },
  created() {
    ...
    async fetchUserData() {
      ...
      try {
        ...
        this.errorMessage =
          ...
          error.message ||
          "Error de red al obtener información del usuario.";
    ...
    async fetchSubjectsWithStudents() {
      ...
      try {
        ...
        if (data.success) {
          ...
          this.errorMessage =
            data.message || "Error al cargar las asignaturas.";
        }
      } catch (error) {
        this.errorMessage =
          error.response?.data?.message ||
          error.message ||
          "Error de red al cargar las asignaturas.";
    ...
    async updateUser() {
      ...
      try {
        ...
        if (data.success) {
          ...
          this.errorMessage =
            data.message || "Error al actualizar el perfil (backend).";
        }
      } catch (error) {
        this.errorMessage =
          error.response?.data?.message ||
          error.message ||
          "Error de red al actualizar el perfil.";
